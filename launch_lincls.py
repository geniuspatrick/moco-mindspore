...
def f(rank_id, args):
    ...
    os.system(f"python -u main_lincls.py {args}")
...
# 8P
# python launch_lincls.py --data /path/to/IN1K --output-dir ./output/lincls --pretrained ./output/moco/.ckpt
# 1P
# python main_lincls.py --data /path/to/IN1K --output-dir ./output/lincls --pretrained ./output/moco/.ckpt --distributed=False
